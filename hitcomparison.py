...
print('original hit count was: ' + str(o_hit_count) + ", giving a hit ratio of: " + str(o_hit_count) + "/" + str(o_total) + "=" + str(o_hit_ratio))
print('new hit count was: ' + str(n_hit_count) + ", giving a hit ratio of: " + str(n_hit_count) + "/" + str(n_total) + "=" + str(n_hit_ratio))